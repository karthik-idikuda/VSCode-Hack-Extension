...
export class SecurityScanner {
    ...
    private secretPatterns: { name: string; pattern: RegExp; severity: 'critical' | 'high' }[] = [
    ...
    private scanForSecrets(lines: string[], content: string): SecurityIssue[] {
        const issues: SecurityIssue[] = [];
    ...
    private scanForInjections(lines: string[], ext: string): SecurityIssue[] {
        const issues: SecurityIssue[] = [];
    ...
    private scanForAuthIssues(lines: string[], ext: string): SecurityIssue[] {
        const issues: SecurityIssue[] = [];
    ...
    private scanForCryptoIssues(lines: string[], ext: string): SecurityIssue[] {
        const issues: SecurityIssue[] = [];
    ...
    private scanForDataExposure(lines: string[], ext: string): SecurityIssue[] {
        const issues: SecurityIssue[] = [];
